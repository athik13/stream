		...
		<div class="col-lg-8">
			...
			<form method="post" action="">
				...
				<div class="pull-right">
					...
					<input type="submit" formaction="<?php echo base_url();?>index.php?payment/paypal_checkout" 
						class="btn btn-primary" id="payment_paypal" disabled value="Pay by paypal">
						
					<input type="submit" formaction="<?php echo base_url();?>index.php?payment/stripe_checkout" 
